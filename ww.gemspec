...
Gem::Specification.new do |s|
  ...
  s.files = ["Rakefile", "lib/ww", "lib/ww/application.rb", "lib/ww/double", "lib/ww/double/mock.rb", "lib/ww/double/spy", "lib/ww/double/spy/request.rb", "lib/ww/double/spy.rb", "lib/ww/double/stub.rb", "lib/ww/double.rb", "lib/ww/server.rb", "lib/ww/servlet.rb", "lib/ww/spy_eye.html.haml", "lib/ww/spy_eye.rb", "lib/ww/store.rb", "lib/ww.rb"]
